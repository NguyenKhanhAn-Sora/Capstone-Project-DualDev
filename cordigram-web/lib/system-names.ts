...
const CHANNEL_MAP: Record<string, Record<string, string>> = {
  ...
  "quy-tắc-máy-chủ":            { vi: "quy-tắc-máy-chủ",              en: "server-rules",      ja: "サーバー-ルール",   zh: "服务器规则" },
  "server-rules":                { vi: "quy-tắc-máy-chủ",              en: "server-rules",      ja: "サーバー-ルール",   zh: "服务器规则" },
  /** Community activation — Cordigram updates channel */
  "cập-nhật-cộng-đồng":         { vi: "cập-nhật-cộng-đồng",         en: "community-updates", ja: "コミュニティ更新", zh: "社区更新" },
