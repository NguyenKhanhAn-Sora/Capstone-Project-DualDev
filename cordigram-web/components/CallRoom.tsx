    ...
    <div className={styles.videoConferenceContainer}>
      ...
      <div className={styles.videoArea}>
        {hasScreenShare ? (
          ...
          <div className={styles.videoGrid} data-participant-count={cameraTracks.length}>
            {cameraTracks.map((track) => {
      ...
      <div className={styles.controlButtons}>
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {isScreenSharing && (
              <path d="M7 10l5 5 5-5" strokeWidth="2.5" />
            )}
          </svg>
        </button>
      ...
      <div className={styles.audioOnlyContent}>
        <div className={styles.participantGrid}>
          {tracks.map((trackRef) => {
            ...
            return (
              <div key={trackRef.participant.sid} className={styles.audioParticipant}>
                <div className={`${styles.avatarPlaceholder} ${trackRef.participant.isSpeaking ? styles.speaking : ''}`}>
                  {trackRef.participant.name?.charAt(0).toUpperCase() || '?'}
                </div>
                <p className={styles.participantName}>{trackRef.participant.name || 'Unknown'}</p>
