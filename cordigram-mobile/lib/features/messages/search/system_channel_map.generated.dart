...
// Run: node tool/gen_channel_map.dart.js (from cordigram-mobile/)
const systemChannelNameRows = <String, Map<String, String>>{
  'chung': {
    'vi': 'chung',
    'en': 'general',
    'ja': '一般',
