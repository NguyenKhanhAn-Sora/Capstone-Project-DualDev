...
/// Hub biểu cảm cho DM — mỗi tab có nút quay lại danh sách.
class DmChatExpressionsHost extends ChatExpressionsHost {
  DmChatExpressionsHost({
  ...
  Widget buildGiphy(
    ...
    return _DmGiphyExpressionsBody(
      chrome: chrome,
      stickers: stickers,
      onBack: onBack,
...
class _DmGiphyExpressionsBody extends StatefulWidget {
  const _DmGiphyExpressionsBody({
    required this.chrome,
  ...
  @override
  State<_DmGiphyExpressionsBody> createState() => _DmGiphyExpressionsBodyState();
}

class _DmGiphyExpressionsBodyState extends State<_DmGiphyExpressionsBody> {
    ...
    if (AppConfig.giphyApiKey.isEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Thiếu Giphy API key trong .env')),
        );
      });
    }
  }
